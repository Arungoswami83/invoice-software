...
public class ReportModelToEntityConverter {
	...
	public Report getAddReport(ReportRequestModel requestModel,Optional<Client>optionalClient,Optional<Invoice>optionalInvoice,Optional<Payment>optionalPayment,Optional<InvoiceType>optionalInvoiceType) {

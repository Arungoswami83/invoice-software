...
//
//import com.amstech.invoice.service.controller.ReportController;
...
//			LOGGER.info("Client doesn't Exist For These Id :{}",reportRequestModel.getClientId());
...
//	        LOGGER.error("InvoiceType doesn't Exist For These Id :{}", reportRequestModel.getInvoiceTypeId());
...
//			LOGGER.info("Invoice doesn't Exist For These Id :{}",reportRequestModel.getInvoiceId());
//			throw new Exception("Client does not exist");
//		}
...
//			LOGGER.info("Sales doesn't Exist For These Id :{}",reportRequestModel.getSalesInvoicesId());
//			throw new Exception("Sales does not exist");
//		}
//	    Optional<Payment>optionalPayment=paymentRepo.findById(reportRequestModel.getPaymentId());
//		if (optionalPayment.isPresent()) {
//			LOGGER.info("Payment doesn't Exist For These Id :{}",reportRequestModel.getPaymentId());
//			throw new Exception("Payment does not exist");
//		}
//		Report report=reportModelToEntityConverter.getAddReport(reportRequestModel, optionalClient, optionalInvoice, optionalPayment, invoiceTypesOptional, optionalSales);
//		Report savedReport=reportRepo.save(report);
//	    LOGGER.info("Saving Reports with ID: {}", savedReport.getId()); 
//	    
//	    ReportResponseModel reportResponseModel=entityToModelConverter.AddResponseInRequest(savedReport);
